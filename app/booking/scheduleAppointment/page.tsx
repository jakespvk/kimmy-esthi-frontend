...
export default function ScheduleAppointment({ searchParams } : {
  ...
  return (
    ...
    <a type="button" href="/booking" className="btn p-1 mx-1 max-w-32 w-32 min-w-fit text-white bg-gradient-to-r 
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <FormField
          ...
          render={({ field }) => (
              ...
              <FormControl>
                <textarea rows={3} placeholder="Dry patches/pigmentation" className="text-sm min-w-full border border-amber-500 
                    focused:border-amber-800 focus-visible:ring-1 ring-amber-700 focus:outline-none shadow-sm rounded-sm size-fit p-2.5" 
                    {...field} />
              </FormControl>
              <FormDescription>
              </FormDescription>
        ...
        <div className="w-full flex justify-center">
            <Button type="submit" className="p-3 mx-3 my-1 max-w-40 w-40 min-w-fit btn text-white bg-gradient-to-r from-amber-400 to-amber-600 
