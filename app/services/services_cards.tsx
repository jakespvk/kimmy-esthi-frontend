      ...
      <div className="relative group" onClick={() => toggleClicked()}>
        <div className="p-5">
          <div className={"card bg-base-100 shadow-xl " + (serviceType === ServiceCardType.AddOn ? "w-60" : "w-80 lg:w-96")}>
            ...
            <div className={"card-body " + (packageItems !== undefined && packageItems.length > 0 ? "h-[18rem] lg:h-[22rem]" : (serviceType === ServiceCardType.AddOn ? "h-24 lg:h-28 py-1 flex items-center justify-center" : "h-44"))}>
