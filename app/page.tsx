...
export default function Home() {
  return (
    <div className="hero h-svh min-h-svh pt-safe-top pb-safe-bottom bg-repeat-round overscroll-none overflow-clip bg-linear-30 from-amber-700 to-amber-400">
      ...
      <div className="hero-content text-center">
        <div>
          ...
          <p className={`${msMadi.className} mb-5 text-4xl md:text-5xl lg:text-6xl`}>
